...
export IMAGE_NAME="cryptist-app-deployment"
export BASE_DIR=$(pwd)
export GCP_PROJECT="cryptist" # Change to your GCP Project
...
--mount type=bind,source=$BASE_DIR/../persistent-folder/,target=/persistent-folder \
